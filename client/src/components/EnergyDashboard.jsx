    ...
    return (
        <div className="flex-1 space-y-4 p-8 pt-6">
          ...
          <div className="flex space-x-4 border-b">
            ...
            <button
              className={`py-2 px-4 ${activeTab === 'disputes' ? 'border-b-2 border-blue-500' : ''}`}
          ...
          <div className="mt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                  <div className="col-span-4 bg-white p-6 rounded-lg shadow">
                    <h3 className="text-xl font-semibold mb-4">Energy Transactions by Type</h3>
                    <EnergyTypeChart />
                  </div>
            ...
            {activeTab === 'analytics' && (
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <div className="col-span-4 bg-white p-6 rounded-lg shadow">
                  <h3 className="text-xl font-semibold mb-4">Detailed Energy Analytics</h3>
